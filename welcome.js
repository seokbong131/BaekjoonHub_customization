...
const createRepo = (token, name) => {
  ...
  let data = {
    ...
    private: true,
    auto_init: true,
    description: 'This is an auto push repository for BOJ (Baekjoon Online Judge) created with [BaekjoonHub_customization](https://github.com/seokbong131/BaekjoonHub_customization).',
  };
